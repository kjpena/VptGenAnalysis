...
config.General.requestName = "ZJ_ptsqmin4_tune48_PDFpSet13"
...
config.JobType.pyCfgParams = [
			   ...
			   'ueTune=CUETP8M1:SpaceShower:alphaSvalue=0.130:BeamRemnants:primordialKThard=1.50:SpaceShower:pT0Ref=2.0',
                           'pdfSet=13',
			   'photos=False',
			   'nFinal=2',
			   'doRivetScan=True',
