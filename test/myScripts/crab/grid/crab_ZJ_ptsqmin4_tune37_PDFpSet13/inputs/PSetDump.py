...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        ueParameters = cms.vstring('Tune:pp 14', 
            ...
            'PDF:pSet=13', 
            'SpaceShower:alphaSvalue=0.110', 
            'BeamRemnants:primordialKThard=2.00', 
            'SpaceShower:pT0Ref=2.5', 
...
process.rivetAnalyzer0 = cms.EDAnalyzer("RivetAnalyzer",
    ...
    OutputFile = cms.string('ZJ_ptsqmin4_tune37_PDFpSet13.w0.yoda'),
...
process.rivetAnalyzer48 = cms.EDAnalyzer("RivetAnalyzer",
    ...
    OutputFile = cms.string('ZJ_ptsqmin4_tune37_PDFpSet13.w48.yoda'),
    ProduceDQMOutput = cms.bool(False),
    UseExternalWeight = cms.bool(True),
    useLHEweights = cms.bool(True)
)
...
process.generation_step = cms.Path(process.ProductionFilterSequence+process.pgen+process.rivetAnalyzer0+process.rivetAnalyzer48)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('ZJ_ptsqmin4_tune37_PDFpSet13.root')
)
