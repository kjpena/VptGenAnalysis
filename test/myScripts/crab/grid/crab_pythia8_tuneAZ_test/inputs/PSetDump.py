...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer15GS/DYToMuMu_M_50_TuneAZ_8TeV_pythia8/GEN-SIM/GenOnly_MCRUN2_71_V1-v3/100000/02B00892-5740-E711-87B1-A0369F7FCDF4.root'),
...
process.rivetAnalyzer = cms.EDAnalyzer("RivetAnalyzer",
    ...
    OutputFile = cms.string('pythia8_tuneAZ.w0.yoda'),
...
process.generation_step = cms.Path(process.rivetAnalyzer)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('pythia8_tuneAZ.root')
)
