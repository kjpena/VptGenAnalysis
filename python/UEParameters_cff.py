...
def getUEParameters(ueName='CUEP8M2T4',pdfSet='LHAPDF6:NNPDF30_lo_as_0130'):
    if 'AZ' in ueName:
    ...
    for param in ['SpaceShower:alphaSvalue','BeamRemnants:primordialKThard','SpaceShower:pT0Ref','SpaceShower:pTmin']:
    ...
    # Running of alphaS: NLO
    ueParameters.extend( ['SpaceShower:alphaSorder = 2'] )
